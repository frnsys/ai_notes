...
When you pass a set of vectors (i.e. a subset of a domain $\mathbb R^n$) through a transformation, the result is called the __image of the set under the transformation__. E.g. $T(S)$ is the image of $S$ under $T$.
