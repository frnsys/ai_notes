...
A word embedding $W : \text{words} \to \Bbb R^n$ is a parameterized function that maps words to high-dimensional vectors (typically 200-500 dimensions).
...
![More complex network, more complex functions [source](https://cs231n.github.io/neural-networks-1/)](assets/layer_sizes.jpeg)
...
![Regularization strength [source](https://cs231n.github.io/neural-networks-1/)](assets/reg_strengths.jpeg)
