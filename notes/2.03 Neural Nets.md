...
As a result of this property, this mapping between layers is often called a __feature map__ (the terms "kernel" and "filter" are used interchangeably with "feature map").

We may include multiple feature maps/filters, i.e. have the input connect to many hidden layers of this kind. Each layer would learn to detect a different feature.
