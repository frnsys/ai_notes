...
Rather than searching through the state-space, we search through _plan-space_ - a graph of partial plans. The nodes are partially-specified plans, the arcs are _plan refinement operations_, and the solutions are _partial-order plans_.
